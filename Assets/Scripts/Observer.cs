...
public class Observer<TSource, TResult> : IDisposable
{
    ...
    public void ConfigureSelect(IReadOnlyReactiveProperty<TSource> source, Func<TSource, TResult> selector, Action<TResult> onNext)
    {
        _source = source;
        _selector = selector;
        _onNext = onNext;
    ...
    public void ConfigureWhere(IReadOnlyReactiveProperty<TSource> source, Func<TSource, bool> predicate, Action<TResult> onNext)
    {
        _source = source;

...
namespace Towers.TargetingStrategies
{
    ...
    public class TargetClosest : ITargetingBehaviours
    {
        ...
        private void FindTarget(TowerEntity tower)
        {
            ...
            {
                Transform potentialTarget = _cache[i].transform;
                ...
                Vector3 origin = tower.transform.position + Vector3.up * 0.5f;
                Vector3 targetPos = potentialTarget.position + Vector3.up * 0.5f; // On vise le centre/haut de l'ennemi

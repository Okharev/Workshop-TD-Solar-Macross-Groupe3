    ...
    public class RoadNetworkDebugEditor : Editor
    {
        ...
        private void OnSceneGUI()
        {
            ...
            for (var i = 0; i < container.Splines.Count; i++)
            {
                ...
                var midT = 0.5f;
                var worldPos = generator.transform.TransformPoint(spline.EvaluatePosition(midT));
                ...
                var forward = Vector3.Normalize(generator.transform.TransformDirection(spline.EvaluateTangent(midT)));
